...
| Endpoint | `POST https://app-dfz0c2wu0jcx-api-nYWNozBb8X3L-gateway.appmiaoda.com/rpc/2.0/tts/v1/create` |
| 生成期 URL | `https://app-dfz0c2wu0jcx-api-nYWNozBb8X3L-gateway.appmiaoda.com/rpc/2.0/tts/v1/create` |
| Auth 模式 | `platform_managed`（traefik: true） |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party domain | `app-dfz0c2wu0jcx-api-nYWNozBb8X3L-gateway.appmiaoda.com` |
| 计费 | 启用（按调用次数计费） |
...
async function createTTSTask(
  ...
  const response = await fetch(
    "https://app-dfz0c2wu0jcx-api-nYWNozBb8X3L-gateway.appmiaoda.com/rpc/2.0/tts/v1/create",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
