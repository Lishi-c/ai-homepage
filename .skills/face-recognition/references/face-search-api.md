...
| Endpoint | `POST https://app-dfz0c2wu0jcx-api-e94GZ5j0PwVa-gateway.appmiaoda.com/rest/2.0/face/v3/search` |
| Auth 模式 | `platform_managed` |
| Auth Header | `X-Gateway-Authorization: Bearer <INTEGRATIONS_API_KEY>` |
| Content-Type | `application/json` |
| third_part_domain | `app-dfz0c2wu0jcx-api-e94GZ5j0PwVa-gateway.appmiaoda.com` |
| 计费 | 是，按调用次数计费 |
...
async function searchFace(
  ...
  const response = await fetch(
    "https://app-dfz0c2wu0jcx-api-e94GZ5j0PwVa-gateway.appmiaoda.com/rest/2.0/face/v3/search",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
